...
<div class="jlc-container">
    ...
    <div class="jlc-col-md-8 jl_main_achv jl_hide_line jl_achv_tpl_list">
        <div class="jl_breadcrumbs">
         ...
         <span class="jl_item_bread">
            <a href="<?php echo htmlspecialchars(category_url($category_slug)); ?>">
               <?php echo htmlspecialchars($category_slug); ?>
            </a>
         </span>
      </div>
        <div class="jl_ache_head">
            <div class="jl_pc_sec_title">
                <h1 class="jl_pc_sec_h">
                    <?php 
                    $color_number = category_color($category_slug);
                    echo htmlspecialchars($category_slug); 
                    ?>
                </h1>
                <div class="post_subtitle_text">
                    <p>
                        <?php echo htmlspecialchars($category_descriptions[$category_slug] ?? ''); ?>
                    </p>
                </div>
            </div>
            <span class="jl_auth_numw">
                <span class="jl_auth_num h1" style="color:<?php echo $color_number;?>">
        ...
        <div class="jl_clear_at block-section jl-main-block jl_wrapper_cat">
            <div class="jl_clear_at">
                ...
                <div class="jl_pagination">
                    <?php if ($page > 1): ?>
                        <a href="<?php echo htmlspecialchars(cn_category_page_url($category_slug, $page - 1)); ?>" class="jl_page_prev">
                    ...
                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo htmlspecialchars(cn_category_page_url($category_slug, $i)); ?>" class="jl_page_link">
                                <?php echo $i; ?>
                            </a>
                        <?php endif; ?>
                    <?php endfor; ?>
                    ...
                    <?php if ($page < $total_pages): ?>
                        <a href="<?php echo htmlspecialchars(cn_category_page_url($category_slug, $page + 1)); ?>" class="jl_page_next">
