    ...
    if ($q === '') {
        ...
        $count_stmt = $db->prepare('
            ...
            WHERE a.status = 1
              ...
              AND (
                    a.titre   LIKE :qTitle
                 OR a.contenu LIKE :qContent
              )
        ');
        $like = '%'.$q.'%';
        $count_stmt->execute(['qTitle' => $like, 'qContent' => $like]);
        ...
        ');
        $stmt->bindValue(':qTitle', $like, PDO::PARAM_STR);
        $stmt->bindValue(':qContent', $like, PDO::PARAM_STR);
